export const TITLE = 'Заказчик и оплата';
export const BUTTON_TEXT = 'Добавить нового заказчика';
export const SUB_NAME = 'Имя';
...
export const segments = [{ id: 1, text: 'На расчетный счет' }, { id: 2, text: 'На карту' }, { id: 3, text: 'Наличными' }]