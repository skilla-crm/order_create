    ...
    return (
        <div className={s.container}>
            ...
            <div className={`${s.phone} ${errorState && s.phone_error} ${disabled && s.disabled}`}>
                <InputMask onBlur={handleError} onFocus={handleResetError} value={value || ''} disabled={disabled} mask="+7 (999) 999-99-99" onChange={handleChangeValue} placeholder='+7 (___) ___-__-__' />
            </div>
